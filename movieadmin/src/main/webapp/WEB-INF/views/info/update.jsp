		...
		<form action="i_updateOK.do" method="post"
			...
			<table id="updateTable">
				...
				<tr>
					...
					<td>${vo2.nickname}<input type="hidden" id="nickname"
				...
				<tr>
					...
					<td><input type="text" id="directors" name="directors"
						value="${vo2.directors}"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2"><input type="date" id="releaseDate"
						name="releaseDate" value="${vo2.releaseDate}"></td>
				</tr>
				<tr>
					<td><label for="showtime">상영시간(분)</label></td>
					<td><input type="text" id="showtime" name="showtime"
						value="${vo2.showtime}"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" id="watchGrade" name="watchGrade"
						value="${vo2.watchGrade}"></td>
				</tr>
				<tr>
					<td><label for="companys">제작사</label></td>
					<td><input type="text" id="companys" name="companys"
						value="${vo2.companys}"></td>
				</tr>
				<tr>
