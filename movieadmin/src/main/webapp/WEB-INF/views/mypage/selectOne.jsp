    ...
    <script type="text/javascript">
        $(function() {
            ...
            function isValidPassword(password) {
                // 영문 대소문자, 숫자, 특수문자 중 하나 이상을 포함하여 8~16자리
                var passwordRegex = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,16}$/;
                return passwordRegex.test(password);
            }

            function isValidUsername(username) {
                // 영문 소문자, 숫자, 밑줄(_)을 포함하여 6~12자리
                var usernameRegex = /^[a-z0-9_]{6,12}$/;
        ...
        <form action="u_insertOK.do" method="post" enctype="multipart/form-data">
            <table class="alt">
                <tr>
                    ...
                    <td><input type="text" id="user_id" name="user_id" value="" placeholder="아이디" maxlength="12"> <span id="result"></span> <span id="result4"></span></td>
                    <td width=150><a href="#" id="u_idCheck">아이디중복체크</a></td>
                </tr>
                <tr>
                    <td><label for="password">비밀번호:</label></td>
                    <td colspan="2"><input type="password" id="password" name="password" value="" placeholder="비밀번호"> <span id="result7"></span> <span id="result8"></span></td>
                </tr>
                <tr>
                    <td><label for="nickname">별명:</label></td>
                    <td><input type="text" id="nickname" name="nickname" value="" placeholder="별명" maxlength="8"> <span id="result2"></span> <span id="result5"></span></td>
                    <td width=150><a href="#" id="u_nicknameCheck">닉네임중복체크</a></td>
                </tr>
                <tr>
                    <td><label for="email">이메일:</label></td>
                    <td><input type="text" id="email" name="email" value="" placeholder="이메일"> <span id="result3"></span> <span id="result6"></span></td>
                    <td width=150><a href="#" id="u_emailCheck">이메일중복체크</a></td>
                </tr>
                <tr>
                    <td><label for="tel">전화번호:</label></td>
                    <td colspan="2"><input type="tel" id="tel" name="tel" value="010" placeholder="전화번호"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2"><input type="radio" id="gender_male" name="gender" value="남자" ${vo2.gender == '남자' ? 'checked' : ''}> <label for="gender_male">남자</label> <input type="radio" id="gender_female" name="gender" value="여자" ${vo2.gender == '여자' ? 'checked' : ''}> <label for="gender_female">여자</label> <input type="radio" id="gender_no" name="gender" value="비공개" ${vo2.gender == '비공개' ? 'checked' : ''}> <label for="gender_no">비공개</label></td>
                </tr>
                <tr>
...
<script>
    document.querySelector("form").addEventListener("submit", function(event) {
        ...
        var passwordInput = passwordInput.value.trim();
